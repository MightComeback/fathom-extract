...
test('isVimeoUrl identifies Vimeo URLs', () => {
  ...
  assert.ok(isVimeoUrl('https://vimeo.com/manage/video/123456789'));
  assert.ok(isVimeoUrl('https://vimeo.com/manage/videos/123456789/advanced'));
...
test('extractVimeoId extracts numeric ID', () => {
  ...
  assert.equal(extractVimeoId('https://vimeo.com/manage/video/123456789'), '123456789');
  assert.equal(extractVimeoId('https://vimeo.com/manage/videos/123456789/advanced'), '123456789');
