...
test('normalizeYoutubeUrl normalizes /watch/<id> URLs', () => {
  assert.strictEqual(
    normalizeYoutubeUrl('https://youtube.com/watch/dQw4w9WgXcQ?t=43'),
...
test('normalizeYoutubeUrl preserves hash timestamps (watch URL)', () => {
  assert.strictEqual(
    normalizeYoutubeUrl('https://youtube.com/watch?v=dQw4w9WgXcQ#t=62'),
    'https://youtube.com/watch?v=dQw4w9WgXcQ&t=62',
  );
});
...
test('normalizeYoutubeUrl normalizes live URLs', () => {
  assert.strictEqual(
    ...
    'https://youtube.com/watch?v=dQw4w9WgXcQ&si=abc',
  );
});
...
test('normalizeYoutubeUrl normalizes embed URLs', () => {
  assert.strictEqual(
    ...
    'https://youtube.com/watch?v=dQw4w9WgXcQ&start=10',
  );
});
...
test('normalizeYoutubeUrl normalizes attribution_link share URLs', () => {
  assert.strictEqual(
    ...
    'https://youtube.com/watch?v=dQw4w9WgXcQ&t=30s&feature=share',
  );
});

test('normalizeYoutubeUrl canonicalizes subdomain watch URLs to youtube.com', () => {
  assert.strictEqual(
...
test('normalizeYoutubeUrl canonicalizes music.youtube.com to youtube.com', () => {
  assert.strictEqual(
